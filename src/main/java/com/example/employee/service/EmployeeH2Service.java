...
public class EmployeeH2Service implements EmployeeRepository{
    ...
    @Autowired
    private JdbcTemplate db; //instance of Jdbc Template
    ...
    public Employee addEmployee(Employee employee){
        ...
        Employee savedEmployee = db.queryForObject("select * from EMPLOYEELIST where employeeName = ? and email= ? and department = ?", new EmployeeRowMapper(), 
    ...
    public Employee updateEmployee(int employeeId, Employee employee){
        ...
        try{
            ...
            Employee exisitingEmployee =  db.queryForObject("select * from EMPLOYEELIST where employeeId = ?", new EmployeeRowMapper(), employeeId); 

            return exisitingEmployee;//return
        }
        catch(Exception e){
            throw new ResponseStatusException(HttpStatus.NOT_FOUND);
        }
